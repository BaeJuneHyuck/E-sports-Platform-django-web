...
from .views import UserRegistrationView, UserLoginView, UserVerificationView, ResendVerifyEmailView, UserMypageView, UserlolpageView, UserMypageOWView
...
urlpatterns = [
    ...
    path('mypage/Overwatch',  login_required(UserMypageOWView.as_view()), name='mypageOW'),
